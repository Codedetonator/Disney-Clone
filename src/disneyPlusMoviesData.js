export function disneyDatabase(firebase){
  
   firebase.firestore().collection("recommend").add({
    ...
    firebase.firestore().collection("new").add({
  ...
  firebase.firestore().collection("recommend").add({
    ...
    firebase.firestore().collection("trending").add({
    ...
    firebase.firestore().collection("original").add({
